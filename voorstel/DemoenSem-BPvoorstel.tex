...
deze gegevens normaliseert en analyseert, om vervolgens automatische rapportages te genereren voor de technische teams en management van het bedrijf. 
...
De meerwaarde voor de doelgroep bestaat uit een framework voor geautomatiseerde security monitoring binnen SaaS en DevOps, dat organisaties helpt risico's beter te beheersen en hun incident response te optimaliseren. GitHub: \url{https://github.com/SemDemoen/bachproef}
\end{abstract}
