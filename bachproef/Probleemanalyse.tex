...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[
        ...
        \node (app3) [right of=waf, xshift=2cm] {SaaS Integratie \\ (bv. Heroku)};
        
        % Make layer
        \node (make) [below of=waf, yshift=-0.6cm] {\textit{Make} \\ (Automatisatie)};
        \node (m365) [right of=make, xshift=2cm] {\textit{M365 Defende}r \\ (Email Alerts)};
