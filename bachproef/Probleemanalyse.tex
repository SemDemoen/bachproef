...
\subsection{Analyse van logging en monitoring}
...
\subsection{Firewallconfiguratie en securityregels}
...
\subsection{Verspreiding van tools en gebrek aan centralisatie}
...
\subsection{Huidige aanpak van incident response}
