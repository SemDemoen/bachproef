...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{architectuurontwerp_diagram.png}
    \caption[Ontwerp van de gelaagde architectuur met lineaire datastroom en gescheiden componenten]{\label{fig:Architectuurontwerp}
    Schematische voorstelling van de architectuurontwerp met verschillende lagen gebaseerd op de noden uit de probleemanalyse.}
\end{figure}
