...
\begin{table}[H]
    ...
    \begin{tabular}{lrrrrrl}
        ...
        \midrule
        \textbf{Totaal} & \textbf{3,857} & \textbf{59} & \textbf{8} & \textbf{2} & \textbf{3,798} & \textbf{98,5\%} \\
        \bottomrule
    \end{tabular}
\end{table}
...
\subsection{P2: Snellere en consistentere detectie}
...
\subsection{P3: Beter overzicht via centralisatie}
...
\subsection{P4 en O5: Objectieve meting via KPI's}
...
\subsection{P5: Operationele efficiëntie ten opzichte van de huidige situatie}
