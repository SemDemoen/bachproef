...
Deze focus sluit aan bij bestaande literatuur, waarin wordt benadrukt dat security in DevOps-omgevingen geïntegreerd moet worden in de ontwikkel- en deploymentprocessen om snelle detectie en effectieve respons mogelijk te maken~\autocite{GruhnKohntopp2021}. Het ontwikkelen van een geautomatiseerde en geïntegreerde monitoringoplossing sluit dan ook rechtstreeks aan bij deze aanbeveling.
...
Om dit doel te realiseren, wordt het onderzoek uitgevoerd in vier fasen, verder beschreven in Hoofdstuk~\ref{ch:methodologie} (Methodologie):
