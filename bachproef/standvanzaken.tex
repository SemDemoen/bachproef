...
% Definitie van security monitoring
...
% Security monitoring binnen het NIST Cybersecurity Framework (Detect & Respond)
...
% Logbeheer en logmanagementprocessen (genereren tot verwijderen)
