...
%TODO SANS Incident Handler’s Handbook - https://www.sans.org/white-papers/33901?utm_source=chatgpt.com
Het SANS Incident Handler’s Handbook beschrijft praktische richtlijnen voor het beheren van cybersecurity-incidenten. Het boek benadrukt het belang van een systematische aanpak, van detectie en analyse tot containment, herstel en lessons learned. Het biedt voorbeelden van procedures, checklists en best practices voor incident response teams, waardoor organisaties beter voorbereid zijn om op effectieve en consistente wijze op beveiligingsincidenten te reageren \autocite{sans2022}.

%TODO Rol van logging en monitoring binnen incident response - https://www.mdpi.com/1424-8220/21/14/4759
Logging en monitoring vormen de kern van een effectief incident response-proces. Door continue logverzameling en real-time monitoring kunnen organisaties verdachte activiteiten vroegtijdig detecteren. Gecombineerd met eventcorrelatie en dashboards kunnen security teams prioriteiten stellen, snelle beslissingen nemen en incidenten efficiënt analyseren. Zonder gedetailleerde en goed gestructureerde logs wordt het moeilijk om de impact van incidenten te beoordelen of oorzaak-analyse uit te voeren, waardoor de respons vertraagt \autocite{Gonzalez-Granadillo_2019}.

%TODO Automatisering binnen incident response (SOAR-achtige concepten) -https://www.mdpi.com/1424-8220/21/14/4759
Automatisering speelt een steeds belangrijkere rol in incident response, met name door SOAR (Security Orchestration, Automation, and Response)-achtige concepten. Door repetitieve taken zoals alerts triage, data gathering en initiële containment te automatiseren, kunnen security teams sneller reageren op incidenten en menselijke fouten verminderen. Automatisering maakt het ook mogelijk om incidenten consistent te behandelen en zorgt ervoor dat organisaties beter kunnen opschalen zonder dat de reactietijd afneemt \autocite{Gonzalez-Granadillo_2019}.
