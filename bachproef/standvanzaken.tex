...
In dit model ondersteunen \textbf{Govern, Identify en Protect} organisaties bij het voorkomen van incidenten, voorbereiden op incidenten en het beperken van de impact, terwijl \textbf{Detect, Respond en Recover} helpen bij het ontdekken, beheren, prioriteren, beheersen, uitroeien en herstellen van incidenten. Bovendien is continue verbetering ingebouwd via de Improvement Category binnen de Identify-functie, waardoor lessen uit alle activiteiten gebruikt kunnen worden om incident response en cybersecurityrisicomanagement voortdurend te optimaliseren\autocite{nist2025}.
