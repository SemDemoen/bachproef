...
\begin{figure}[h!]
    ...
    \caption[Architectuur van een IDPS]{Schematische weergave van de basisarchitectuur van een IDPS, met de vier functionele modules: E-blocks (Event-boxes), D-blocks (Database-boxes), A-blocks (Analysis-boxes) en R-blocks (Response-boxes).}
